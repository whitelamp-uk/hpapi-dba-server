...
('whitelamp-uk',	'hpapi-dba',	'\\Hpapi\\Dba',	'rowsSelect',	'Select rows from a given table',	''),
...
('admin',	'whitelamp-uk',	'hpapi-dba',	'\\Hpapi\\Dba',	'rowsSelect'),
...
('whitelamp-uk',	'hpapi-dba',	'\\Hpapi\\Dba',	'rowsSelect',	1,	'Data object',	0,	'object'),
...
('HpapiModel',	'hpapiDbaColumns',	'whitelamp-uk',	'hpapi-dba',	'\\Hpapi\\Dba',	'rowsSelect'),
