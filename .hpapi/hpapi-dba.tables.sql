...
CREATE TABLE IF NOT EXISTS `hpapi_dba_access` (
  ...
  CONSTRAINT `hpapi_dba_access_ibfk_1` FOREIGN KEY (`access_Node`, `access_Model`) REFERENCES `hpapi_dba_database` (`database_Node`, `database_Model`),
...
CREATE TABLE IF NOT EXISTS `hpapi_dba_columnevent` (
  ...
  CONSTRAINT `hpapi_dba_columnevent_ibfk_5` FOREIGN KEY (`columnevent_Node`, `columnevent_Model`) REFERENCES `hpapi_dba_database` (`database_Node`, `database_Model`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


CREATE TABLE IF NOT EXISTS `hpapi_dba_database` (
  ...
  CONSTRAINT `hpapi_dba_database_ibfk_1` FOREIGN KEY (`database_Node`) REFERENCES `hpapi_dba_node` (`node_Node`),
  CONSTRAINT `hpapi_dba_database_ibfk_2` FOREIGN KEY (`database_Model`) REFERENCES `hpapi_model` (`model_Model`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `hpapi_dba_export` (
  ...
  CONSTRAINT `hpapi_dba_export_ibfk_3` FOREIGN KEY (`export_Node`, `export_Model`) REFERENCES `hpapi_dba_database` (`database_Node`, `database_Model`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `hpapi_dba_import` (
  ...
  CONSTRAINT `hpapi_dba_import_ibfk_3` FOREIGN KEY (`import_Node`, `import_Model`) REFERENCES `hpapi_dba_database` (`database_Node`, `database_Model`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `hpapi_dba_imported` (
  ...
  CONSTRAINT `hpapi_dba_imported_ibfk_3` FOREIGN KEY (`imported_Node`, `imported_Model`) REFERENCES `hpapi_dba_database` (`database_Node`, `database_Model`),
  CONSTRAINT `hpapi_dba_imported_ibfk_5` FOREIGN KEY (`imported_Export_Node`, `imported_Export_Model`, `imported_Transport`, `imported_Export_Datetime`) REFERENCES `hpapi_dba_export` (`export_Node`, `export_Model`, `export_Transport`, `export_Export_Datetime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `hpapi_dba_sprevent` (
  ...
  CONSTRAINT `hpapi_dba_sprevent_ibfk_5` FOREIGN KEY (`sprevent_Node`, `sprevent_Model`) REFERENCES `hpapi_dba_database` (`database_Node`, `database_Model`),
...
CREATE TABLE IF NOT EXISTS `hpapi_dba_tableevent` (
  ...
  CONSTRAINT `hpapi_dba_tableevent_ibfk_4` FOREIGN KEY (`tableevent_Node`, `tableevent_Model`) REFERENCES `hpapi_dba_database` (`database_Node`, `database_Model`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `hpapi_dba_trash` (
  ...
  CONSTRAINT `hpapi_dba_trash_ibfk_1` FOREIGN KEY (`delete_Model`, `delete_Table`) REFERENCES `hpapi_dba_table` (`table_Model`, `table_Table`),
  CONSTRAINT `hpapi_dba_trash_ibfk_2` FOREIGN KEY (`delete_Usergroup`) REFERENCES `hpapi_usergroup` (`usergroup_Usergroup`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
